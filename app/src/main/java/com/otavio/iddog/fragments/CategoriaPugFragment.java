...
public class CategoriaPugFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.pug_fragment, container, false);
        ...
        Carregar(token,getString(R.string.categoriaPug));

        recyclerView = view.findViewById(R.id.recycler_pug);
