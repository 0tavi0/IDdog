...
public class CategoriaHoundFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.hound_fragment, container, false);
        ...
        Carregar(token,getString(R.string.categoriaHound));

        recyclerView = view.findViewById(R.id.recycler_hound);
    ...
    private void Carregar(String token, String categoria) {
